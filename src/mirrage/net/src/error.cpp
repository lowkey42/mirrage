		  ...
		  public:
			...
			std::string message(int e) const override
			{
				switch(static_cast<Net_error>(e)) {
					...
					case Net_error::unknown_channel: return "The requested channel hasn't been declared.";
					case Net_error::connection_error: return "Couldn't connect to a server.";
					case Net_error::not_connected: return "Tried to send a packet without being connected.";
					case Net_error::unspecified_network_error: return "ENet failed and didn't tell us why!";
				}
			...
			std::error_condition default_error_condition(int e) const noexcept override
			{
				switch(static_cast<Net_error>(e)) {
					...
					case Net_error::unspecified_network_error: return Error_type::network_unkown_error;
				}
