...
namespace mirrage::input {
	...
	enum class Pad_stick : int8_t { invalid = -1, left, right };
	...
	sf2_enumDef(Pad_stick, left, right);
...
namespace std {
	template <>
	struct hash<mirrage::input::Key> {
		size_t operator()(mirrage::input::Key ac) const noexcept { return static_cast<size_t>(ac); }
	};
	template <>
	struct hash<mirrage::input::Pad_button> {
		size_t operator()(mirrage::input::Pad_button ac) const noexcept { return static_cast<size_t>(ac); }
	};
	template <>
	struct hash<mirrage::input::Pad_stick> {
		size_t operator()(mirrage::input::Pad_stick ac) const noexcept { return static_cast<size_t>(ac); }
	};
	template <>
